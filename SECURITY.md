...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/network-outpost/security/advisories/new)
...
- This repository (`hyperpolymath/network-outpost`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/network-outpost/security/advisories)
...
When using Network Outpost, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/network-outpost/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/network-outpost/security/advisories/new) or j.d.a.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/network-outpost/discussions) |
...
*Thank you for helping keep Network Outpost and its users safe.* 🛡️
